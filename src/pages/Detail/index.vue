      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="skuNum" @change="skuNumInput">
                <a href="javascript:" class="plus" @click="skuNum++">+</a>
                <a href="javascript:" class="mins" @click="skuNum > 1 ? skuNum-- : skuNum = 1">-</a>
              </div>
              <div class="add">
                <!-- 在加入购物车和路由跳转前，发请求，将购买产品的信息通过请求形式通知服务器，然后服务器存储 -->
    ...
    methods:{
      ...
      async addShopCart(){
        try {
            ...
            //将产品信息带给下一级路由组件，用会话存储。但会话存储只能存储字符串，因此需要把对象转为字符串
